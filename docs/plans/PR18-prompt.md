# PR18: Unsupervised Anomaly Detection — Isolation Forest
...
- **Must merge first:** PR14 (config-wired thresholds — need anomaly config fields), PR17 (calibration — need distribution understanding to validate anomaly scores)
- **External dependencies:** None (pure Go)
- **Can be parallel with:** None (sequential after PR17; PR19 uses anomaly scores but can start after PR18)
...
- [ ] Create feature branch: `git checkout -b pr18-anomaly-detection`
...
- [ ] Pull latest main
- [ ] Create feature branch from main: `git checkout -b pr18-anomaly-detection`
...
- [ ] Push to branch `pr18-anomaly-detection`
- [ ] Open pull request
