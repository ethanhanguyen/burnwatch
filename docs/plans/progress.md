...
## Overall: 10/10 PRs complete (v1), 2/8 PRs complete (v2)
...
Start PR13: Token-Based Heuristics. Adds H6–H9 heuristics using the token baselines from PR12. See `docs/plans/PR13-prompt.md`.
